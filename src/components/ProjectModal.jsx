    ...
    return (
        ...
        >
          ...
          <motion.div
            ...
            aria-modal="true"
          >
            <div className="w-screen h-[85vh] bg-card border-y border-border rounded-none shadow-xl overflow-hidden flex flex-col">
              {/* Header */}
              ...
              <div
                className={`flex-1 min-h-0 grid ${
                  hasGallery ? "grid-cols-[minmax(0,55%)_minmax(0,45%)]" : "grid-cols-1"
                } gap-0`}
              >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {d.skills.map((s, i) => (
                          <div key={i} className="group relative">
                            <span
                              className="inline-flex items-center gap-1 rounded-lg border border-border px-2.5 py-1 text-sm bg-background"
                              title={s.info}
                            >
                            ...
                            <div
                              className="pointer-events-none absolute left-1/2 -translate-x-1/2 mt-2 whitespace-nowrap
                                         rounded-md border border-border bg-card px-2 py-1 text-[11px] text-foreground/90
                ...
                {/* RIGHT: gallery (~45% width) */}
                {hasGallery && (
                  <aside className="border-l border-border p-4 overflow-y-auto bg-background/40">
